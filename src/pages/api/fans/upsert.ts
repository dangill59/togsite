...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    // Note: welcome email isn't sent here. It fires from /api/generate-hero
    // after the first successful AI hero generation, so we can include the
    // hero card image in the body.
